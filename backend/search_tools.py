...
class CourseOutlineTool(Tool):
    """Tool for getting course outlines with title, link, and lesson details"""
    ...
    def execute(self, course_title: str) -> str:
        """
        Get course outline with title, link, and lesson details.
        ...
        try:
            ...
            if not results or not results.get('metadatas') or not results['metadatas']:
                return f"Course outline not found for '{resolved_course_title}'"
            
            metadata = results['metadatas'][0]
            
            # Extract course information
            course_title_full = metadata.get('title', resolved_course_title)
            ...
            outline = f"**Course Title:** {course_title_full}\n"
